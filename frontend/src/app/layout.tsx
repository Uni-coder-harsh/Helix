...
export const metadata: Metadata = {
  ...
  description: "A secure, transparent, event-driven governance system for modern cities and citizen empowerment.",
};
          ...
          <div className="flex min-h-screen flex-col">
              ...
              <div className="container mx-auto flex h-16 items-center justify-between px-4 sm:px-6">
                <div className="flex items-center gap-6">
                  <Link href="/" className="flex items-center space-x-2.5">
                    <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-primary text-white shadow-md shadow-primary/20">
                      <span className="text-lg font-bold tracking-tighter">H</span>
                    </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="hidden sm:flex items-center gap-2 border-l pl-4">
                    ...
                    <span className="text-xs font-semibold">Jan Doe (Officer)</span>
                  </div>
                </div>
              </div>
            </header>
            ...
            <footer className="border-t py-6 bg-slate-50 dark:bg-slate-900/50">
              <div className="container mx-auto px-4 sm:px-6 flex flex-col md:flex-row items-center justify-between text-xs text-muted-foreground gap-4">
                <div>
                  &copy; {new Date().getFullYear()} Helix Platform. Under the Governance Ethos of the Helix Constitution.
                </div>
                <div className="flex gap-4">
                  <a href="#" className="hover:underline">Documentation</a>
                  <a href="#" className="hover:underline">Privacy Policy</a>
                  <a href="#" className="hover:underline">System Architecture (HELIX-ARCH-007)</a>
                </div>
              </div>
            </footer>
          </div>
